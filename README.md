About harlequin-mysql-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/harlequin-mysql-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/harlequin-mysql-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add harlequin-mysql
# for installing globally
pixi global install harlequin-mysql
```
...
It is possible to list all of the versions of `harlequin-mysql` available on your platform:
...
```
pixi search harlequin-mysql --channel conda-forge
```
